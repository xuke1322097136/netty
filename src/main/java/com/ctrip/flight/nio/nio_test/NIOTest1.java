...
public class NIOTest1 {
    public static void main(String[] args) {
        ...
        System.out.println("在flip之前，position的值：" + intBuffer.position());
        ...
        //刚开始初始化的时候，position初始化为0，capacity和limit的值都指向容量大小(从0开始计算的话，就等于IntBuffer的长度)，
        // mark暂时不用，每次往IntBuffer里写的时候只动position的值，往右移动
